			...
			>
				<div className='code-example-container'>
					<div className='code-example'>
						...
						<div className='code-line'>
							<span>console.log(quiz.question); </span>
							<span className='code-comment'>{'// Soru metni'}</span>
						</div>
						<div className='code-line'>
							<span>console.log(quiz.difficulty); </span>
							<span className='code-comment'>{'// Zorluk seviyesi'}</span>
						</div>
						<div className='code-line'>
							<span>console.log(quiz.answers); </span>
							<span className='code-comment'>{'// Cevap seçenekleri'}</span>
						</div>
						<div className='code-line code-comment'>
